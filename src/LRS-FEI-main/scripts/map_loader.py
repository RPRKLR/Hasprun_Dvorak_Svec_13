...
def init(map_name, altitude, start_x, start_y, end_x, end_y, csv_name):
    print("/home/lrs-ubuntu/Desktop/git-lrs/Hasprun_Dvorak_Svec_13/src/LRS-FEI-main/scripts/" + map_name + "" + altitude + ".pgm")
    with open("/home/lrs-ubuntu/Desktop/git-lrs/Hasprun_Dvorak_Svec_13/src/LRS-FEI-main/scripts/" + map_name + "" + altitude + ".pgm", "rb") as file:
        byte_data = file.read()
